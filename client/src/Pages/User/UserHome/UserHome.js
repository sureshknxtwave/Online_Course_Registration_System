...
function UserHome() {
  ...
  return(
    <div >
      ...
      <div className="blog-section " id="blogSection">
        <div className="text-center mb-4 mt-4">
          <h1 className="blog-section-hea">Learning focused on your goals</h1>
          <h6 className="blog-section-dis">These courses will teach you the essential skills needed to build dynamic and interactive websites.</h6>
        </div>
        
      <div className=" embed-responsive embed-responsive-16by9">
        <iframe title="r" className="blog-section-video embed-responsive-item" src="https://www.youtube.com/embed/ysEN5RaKOlA?rel=0" allowfullscreen></iframe>
      </div>
      </div>
      ...
      <div className="ratings-cards" id="feedBack">
        <div className='container'>
          <div className="row">
